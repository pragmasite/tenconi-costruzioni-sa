    ...
    <section className="relative min-h-screen overflow-hidden pt-20">
      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <motion.h1
          ...
          className="mb-6 max-w-4xl font-bold text-5xl text-white md:text-6xl lg:text-7xl leading-tight"
        >
          {t.hero.title1}
          <br />
        ...
        >
          ...
          >
            <a href="mailto:info@tenconicostruzioni.ch">
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 1 }}
          className="mt-12 flex items-center gap-2 text-white/60 text-sm font-medium"
        >
